    ...
    <div className="bg-[#0a0a0f] min-h-[calc(100vh-64px)] py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="bg-[#13111c] border border-white/10 rounded-2xl p-8 mb-12 max-w-lg mx-auto transform hover:scale-105 transition duration-300">
          ...
          <a href="https://github.com/madasamy1990/Interview-AI/releases/download/v1.0.0/Crack.it.Setup.1.0.0.exe" className="w-full bg-[#7c3aed] hover:bg-purple-600 text-white font-bold py-4 px-6 rounded-xl transition text-lg flex items-center justify-center shadow-[0_0_20px_rgba(124,58,237,0.4)]">
